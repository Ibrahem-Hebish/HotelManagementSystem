    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HotelEvaluations", x => new { x.HotelId, x.UserId });
                    table.CheckConstraint("CK_HotelEvaluations_Rate", "Rate >= 0 AND Rate <= 5");
                    table.ForeignKey(
                        name: "FK_HotelEvaluations_Hotel_HotelId",
                        column: x => x.HotelId,
                        principalTable: "Hotel",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HotelEvaluations_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.InsertData(
                table: "Hotel",
                columns: new[] { "Id", "City", "Country", "DeletedAt", "IsDeleted", "Name", "Phone", "Street" },
                values: new object[,]
                {
                    { 1, "Los Angeles", "USA", null, false, "Hotel California", "+1 800 123 4567", "123 Sunset Blvd" },
                    { 2, "Zubrowka", "Europe", null, false, "The Grand Budapest Hotel", "+48 123 456 789", "456 Grand St" }
                });

            migrationBuilder.InsertData(
                table: "Room",
                columns: new[] { "Id", "Area", "DeletedAt", "Description", "DiscountPercentage", "HotelId", "IsDeleted", "PricePerNight", "Status", "Type" },
                values: new object[,]
                {
                    { 1, 30m, null, "Deluxe Room with sea view", 0, 1, false, 150.00m, 0, 3 },
                    { 2, 25m, null, "Standard Room with city view", 0, 2, false, 100.00m, 0, 0 }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HotelEvaluations_UserId",
                table: "HotelEvaluations",
                column: "UserId");
