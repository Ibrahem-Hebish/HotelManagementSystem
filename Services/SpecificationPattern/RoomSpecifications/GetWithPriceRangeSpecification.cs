...
public class GetWithPriceRangeSpecification(decimal minPrice, decimal maxPrice) : ISpecification<Room>
{
    public Expression<Func<Room, bool>> Filter
    {
        get
        {
            return room => room.TotalPrice >= minPrice && room.TotalPrice <= maxPrice;
        }
